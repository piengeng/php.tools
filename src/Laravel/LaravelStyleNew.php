<?php
class LaravelStyleNew extends AdditionalPass {
	...
	public function format($source) {
		...
		// $source = $this->noSpaceBetweenFunctionAndBracket($source);
	...
	// private function noSpaceBetweenFunctionAndBracket($source) {
	// 	// print_r(explode("\n", $source));
	// 	// echo "===================================\n";
	// 	// print_r($this->tokensInLine($source));
